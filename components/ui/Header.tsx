...
import { Phone, Mail, Clock, MapPin, Menu, Search, User, X, Home, Info, Stethoscope, Contact } from 'lucide-react';
...
const Header: React.FC<HeaderProps> = ({ onLoginClick, onHomeClick }) => {
    ...
    <header className="bg-white shadow-sm sticky top-0 z-40">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-2 hover:text-primary transition-colors">
              ...
              <div className="flex gap-2">
                ...
                <a href="mailto:info@drsetzer.net">info@drsetzer.net</a>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
        ...
        <nav className="hidden lg:flex items-center gap-8">
           <button onClick={() => window.scrollTo({top: 0, behavior: 'smooth'})} className="text-sm font-semibold text-slate-600 hover:text-primary transition-colors">Home</button>
